...
\newcommand\reporttitle{Simple Online Realtime Tracking Algorithm Implementation on Hardware}

% Insert course code, name, quartile number and year (or any other subtitle)
\newcommand\reportsubtitle{
ENR 497 BTech Engineering Project 
8th Semester, 2025-26
}
...
\pagestyle{fancy}
\lhead{\includegraphics[height = 20pt]{Figures/0. General/HorizontalStack Cropped.jpeg}}
\rhead{\reporttitle}
